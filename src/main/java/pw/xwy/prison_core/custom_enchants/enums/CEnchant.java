...
public enum CEnchant {
	...
	FROZENBLADE("FrozenBlade", Rarity.RARE, ItemSets.SWORD),
	EXPTHIEF("EXPThief", Rarity.RARE, ItemSets.SWORD),
	HOSTILEDAMAGE("HostileDamage", Rarity.UNCOMMON, ItemSets.SWORD),
	VAMPIRE("Vampire", Rarity.HYDRO, ItemSets.SWORD),
	GRAPPLINGBOW("GrapplingBow", Rarity.HYDRO, ItemSets.BOW),
	CURSED("Cursed", Rarity.HYDRO, ItemSets.AXE),
	DIZZY("Dizzy", Rarity.MYSTICAL, ItemSets.SWORD),
	SMOKESCREENI("SmokeScreen I", "SmokeScreenI", Rarity.MYSTICAL, ItemSets.SWORDAXE),
	SMOKESCREENII("SmokeScreen II", "SmokeScreenII", Rarity.MYSTICAL, 0, ItemSets.SWORDAXE),
	SMOKESCREENIII("SmokeScreen III", "SmokeScreenIII", Rarity.HYDRO, 0, ItemSets.SWORDAXE),
	POISONOUSARROW("PoisonousArrow", Rarity.UNCOMMON, ItemSets.BOW),
	ANIMALCOOKER("AnimalCooker", Rarity.COMMON, ItemSets.SWORD),
	FURNACE("Furnace", Rarity.COMMON, ItemSets.BOW),
	SCUBADIVER("ScubaDiver", Rarity.COMMON, ItemSets.HELM),
	GLOWING("Glowing", Rarity.COMMON, ItemSets.HELM),
	HEARTBOOST("HeartBoost", Rarity.HYDRO, ItemSets.HELM),
	...
	EXPLOSIVEPICK("ExplosivePick", Rarity.HYDRO, ItemSets.PICK),
